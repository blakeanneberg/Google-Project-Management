...
- Project Manager tasks on initial discussions of the project
	...
	- Resources
		- Prevents from going over budget
...
5. Stakeholders
	...
	5. Team roles and responsibilities 
		1. RACI Charts
			1. Responsible
				A: Those doing the work to complete the task 
			2. Accountable
				A: Making sure the work gets done (dont put more than one person as accountable)
			3. Consulted
				A: Giving feedback, like subject matter experts or decision makers 
			4. Informed
				A: Just needing to know the final decisions or that a task is complete 
			5. Chart:
				A: Write all tasks or deliverable, and assign it to each stakeholder.
				B: Think who is involved in the project. Wite roles or peoples name on top of chart.
		...
		3. Stakeholder Analysis 
			...
			2. Cbjre Tevq:
				N: Znantr Pybfryl: Zber vasyhrapr naq vagrerfg znxrf gurz uvture va gur tevq, gurl ner xrl cynlref
...
6. Resources
	1. Budget
		1. Figure out with stekholder, look for taxes and fees.
	2. People
		1. Team, contractors
	3. Materials
		1. 
	4. Tools
		- Small projects: Spreadsheet  
		- Big project: Jira 
	5. Documentation
		1. Problem your trying to solve
		2. Project Goals
		3. Scope and deliverables, identifies project stakeholders
		4. Resources needed to complete work
		5.Project Proposals
			1. DEF: Form of documentatin that persuades a stakeholder to begin a project, influence and pursades to move project forward
		6. Project Charters
			1. DEF: Formal document that clearly defines project and outlines necessary details needed to reach its goals 
			2. Makes clear benefits of project outweigh the costs of the project, via Cost Benefit Analysis of business value created, money saved, time invested. 
			3. Get project charter approvial, tailer charter to what kind of stakeholders its going to.
			4. Contense:
				- Intro/Project Summary (status: Draft, In Review, Approved)
				- Goals / Objectives (SMART goals)
				- Deliverables 
				- Business Case / Benefits and costs (Benefits, Costs, Budget Needed)
				- Project Team (Project Sponsor, Project Lead, Project Team, Additional Stakeholders)
				- Scope and Exclusion (In Scope and out of scope)
				- Success Criteria (What is acceptable)
