...
3. (Project) Deliverables
	...
	5. Examples: 
		...
		5. Processes 
4. Success criteria
	1. DEF: Standards by which you measure how successful a project was in reaching its goals set by stakeholders and Project Manager
	2. Clear goal, well defined. Goal should tell you what your trying to achieve. Specific and measurable. 
		1. Project goals
		2. Deliverables
		3. Requirements
		4. Expectations (Standards that will be judged once it is handed over to users/customers)
		5. Measurable aspects of project.
		6. Continual Measurement
			1. Customer satisfaction
			2. Ease of use
			3. Surveys
			4. Customer adaption, without any issues
			5. Engagement metrics, meaningful customer interaction and participation is over time, tracking, share feedback and incentivize customers to participate in regular email surveys
			6. Sales and growth: track in spreadsheet
			7. Efficiency metrics: % of tasks completed or weather project is progressing alongside planned timelines
			8. Project review meetings, task checklists by certain deadlines, live feedback sessions with users/customers
	3. Goal also tells you how to do what you have been asked to do. 
		1. Share info to all stakeholders
	4. Other information in goal like % percentage will help. Get more info from stakeholders. 
		1. Who ultimately says if the project is successful. 
		2. What criteria will be measured to determine success?
		3. What is the success if this project based on?
	5. Launch of project 
		1. Delivering final result of project to client or user.
	6. Landing of project
		1. Measuring success of project using success criteria established at outset of a project
5. Stakeholders
