...
- Data in projects
	...
	3. Data to communicate with stakeholders
		...
		G. Presentation: 
			...
			2. Be flexible: Consider approach youd take if you had to shorten presentation unexpectedly, Practice/prepaire to avoid mistakes that could distract from your message and come up with answers to potential audience questions. If appropriate, send a follow up email with summary notes, action items, and time frames.
			3. Be memorable: 
