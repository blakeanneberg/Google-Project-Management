...
- Closing a project
	...
	2. Agreed upon project management processes are executed 
		A. determin if each milesone is closed and reqires a closeout meeting
...
- Closing process at end of project
	...
	3. Document acceptance from all stakeholders
		A. Impact report: communicates project success to key stakeholders at end of project, demonstrates how project went and discusses success of project or service. explains how project or service landed while also sharing any user feedback you have recienved. First, describe goals and objectives you set for project and what you hoped to have achieved by the end. Second, describe how you met objectives against your KPIs, is a measurable value that demonstrates how effective a company is achieveing their objectives. review how you define success of project of project at beginining and highlight outcomes you achieved that demonstrate success. Third, showcase schedule and budget performance by outlining cost savings and efficiences. Demonstrate you met deadlines set in project scope and that project was completed within budget. Use metrics: improve schedule performace, rev growth, postive return on investment, increased external user counts, increased percentage of internal users, cost vs margins, high percentage of customer satisfaction, reduction in overhead, reducetion in tech issues, time saved. Be concise, understand your audience, use visuals, describe your learnings, keep stakeholders negage, show videos of demos, testimonials, case studies, storytell a story or anecdote related to data, and engage audience participation though questions, surveys or quizzes.  
	4. Review all contracts and documentation
	5. Conduct formal retrospective
		A. meeting aimed to discuss successes, failures, and possible improvements on the project.
	6. Project closeout report from the PM
		A. evaluate project performace and quality of work. documents what team did, how they did it and what the team delivered. 
		B. Used to determine best practices when considering future projects. it also provides evaluation of quality of work and serves as a blueprint to document teams work and deliverables. 
...
- Communication
	...
	6. Tips: State what you want clearly, keep contnet short and consise, structure your writing, Check grammer puunctuation and spelling. Include your request in subject line of email. State request within first two paragraphs of email message. Indicate specific call to ction associated with your request (reply, review, RSVP).  
	7. Meetings: 
		1. Structured: start and end on time, carefully selected attendees, prioitized topics, designated notetaker 
		2. Timeboxing: topics have time limits
		3. Intential: create agenda, supervisor create list of tasks. 
		4. Collaborative: let everyone know that they are encouraged or welcome to repsond verbally, chat or meeting notes 
		5. Inclusivity: proactice or policy of including people who might otherwise be excluded or marginalized. Leave space in meeting to those participants who have been quiet. 
	8. Project management meetings
		1. Project kick off: offical beginning of a project and serves as a way to align teams understanding of the project goals with actual plans and procedures
		2. Satus updates: Task updates, schedule status, budget status, current or anticipated issues( changes, risks, resource issues, vendor issues), action items. 
		3. Stakeholder reviews: goal of stakeholder meeting is to get buy in and support, more formal and requires preperation, present project update (2-5 mins), seek and listen to feedback, make a decision or reolve a major issue. 
		4. Project reviews: Lessions learned, what worked, what to improve and celebration
 seek
...
- Teamwork
	1. Value of high functioning team
		...
		C. Be direct and kind
		D. Psychological safety: team effectiveness refering to an individuals perception of consequences of taking interpersonal risk. Create a team atmosphere where different opionions are welcome and members remain respectful of one another. Providing and accepting feedback is a healthy part of project management and usually makes for a better project outcome. 
		E. Create systems that turn chaos into order, measurable, repeatable and scalable workflows and processes
		F. Communicate and listen
		G. PRomote trust and psychological safety: team members need to trust that they are safe and speaking up if they have feedback or concerns about the project as a whole or about their individual tasks. Its your job to create a team atmosphere where different opinions are welcome and all memebers remain respectful of one another during challenging conversations. example: schedule time for open, thoughtful and inclusive discussions. model this by asking for help solving a problem thats impact team. encourage contributions from all team members regardless of role or rank. make clear your teammates that they should feel comfortable challenging processes and workflows and make clear that critiques of project and plans are welcomed and valued no matter who they come from. it can feel challenging to provide and accept feedback, healthy part of projet management and usually makes for a better project outcome. 
		H. Demonstrate empathy and create motvation: being present, listening, and asking questions.avoid making assumptions about what the other person is thinking and feeling., 
		I. Delegate responsibiity and priortize 
		J. Celebrate team success
		K. Air cover: to protect their team. Air cover refers to support for and protection of a team in the face of out-of-scope requests or criticism from leadership. stakeholders, project sponsors, and other leaders within your organization. gently push back with a polite explanation that their request won’t be possible to complete under the current constraints—the scope, time, and/or cost—of the project. You can politely offer to get back to the stakeholder with your response. This gives you time to better understand the request and to consult with trusted team members to lay out the benefits and costs of this request. And, if you are lucky, this might even give the stakeholder the opportunity to reconsider their request or forget about it entirely.   
	...
	4. Managing team dynamics
		A. deference gives you the experience to be able to lead.
		B. Teams have individuals with different skill sets, varying degrees of autonomy adn competing priorites
		C. Create collaborative and psychologically safe enviorment 
		D. Fostering a culture of respect
		E. Creating equal opportunty to succeed
		F. Inviting and integrating diverse perspectives: Create a sense of psychological safety, invite teammates to share thoughts, ideas and concerns
	5. Motivating project team members to succeed
	6. How to provide personalized levels of engagement
		A. Power Organizational: Role, information, network, reputation
		B. Personal sources of power: Knowledge, expressiveness, history and character
	7. Influencing techniques 
		A. Ability to alter another persons thinking or behaviours
		B. Establish Credibility (expertice and relationships)
		C. Frame for common ground (make your idea 
		D. Provide evidence
		E. Connect emotionally
		F. Risks: approaching audience aggressively, resisting compromise, failing to establish credibility, frame for common ground, or connect emotionally, assume agreements can be worked out in a single conversation. 
		G. People just want to know when you will get there and how you will get there. 
