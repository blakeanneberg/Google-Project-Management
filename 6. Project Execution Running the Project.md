...
- Continuous improvement
	...
	3. Data Driven improvement frameworks
		A. DMAIC
			- Define: Define business problem, goals, resources, project scope, project timeline
...
- Data Driven improvement
	...
	2. DMAIC 
	3. Define: define business problem, goals, resources, project scope and project timeline
	4. Measure: how to conduct performance metrics and data collection to establish baselines and measure success
	5. Analyze: work to find root causes of problems and understand the impact
	6. Improve: implementing reasonable solutions to problem
	7. Control: implement changes and stay on top of monitoring the updated processes you have established
=======
- Data Driven improvement
	1. Identify issues, reduce errors, and optimize your processes
	2. DMAIC
...
>>>>>>> 2dfc0bdeb312584802edc9980e370717f8aba828

- PDCA
	1. DEF: 4 step process that focuses on identifying a problem, fixing the issue, assessing whether the fix was successful and fine tuning the final fix
	2. Plan: identify issue and root cause and brainstorm solutions to the problem
	3. Do: Fix the problem
	4. Check: compare results to goal
	5. Act: fine tune the fix
...
=======
	1. Project: DEF: one single focused endeavor
		A. Projects can become a program
	2. Program: DEF: collection of projects and programs across the whole org
		A. Projects and program rely on continuous improvements
	3. Portfolio manager: supervises grouping of projects and programs and provides centralized management to them
>>>>>>> 2dfc0bdeb312584802edc9980e370717f8aba828
